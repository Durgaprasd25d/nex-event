...
import api from '../api';
import { Mail, Lock, AlertCircle, ArrowRight, Shield, Sparkles } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="h-screen bg-bg-obsid ian flex items-center justify-center p-6 md:p-12 relative overflow-hidden pt-24 lg:pt-32">
      {/* Background Glows */}
      ...
      <div className="w-full max-w-[1400px] h-full max-h-[82vh] lg:max-h-[780px] flex flex-col lg:flex-row gap-0 relative z-10 items-stretch shadow-4xl">
        ...
        <motion.div
          ...
          className="relative flex-1 min-h-0 rounded-none overflow-hidden border border-ghost-border group"
        >
          <img
            src={HERO_BG}
            alt="Atmosphere"
          ...
          <div className="absolute bottom-0 left-0 p-10 lg:p-14 flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-4">
              <h1 className="text-5xl lg:text-7xl font-black tracking-tighter text-white leading-[0.85] drop-shadow-2xl">
                Illuminate <br />
              ...
              <p className="text-lg lg:text-xl text-on-surface-variant max-w-lg font-medium leading-relaxed italic opacity-80">
                The sanctuary for world-class organizers and experience seekers.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
          className="flex-1 bg-surface-panel rounded-none border border-ghost-border p-10 lg:p-14 flex flex-col justify-between"
        >
          <div className="flex flex-col gap-12 h-full">
            ...
            <div className="space-y-2">
              <h2 className="text-4xl lg:text-6xl font-bold tracking-tighter text-on-surface leading-none">Welcome Back</h2>
              <p className="text-on-surface-variant font-medium text-base lg:text-lg tracking-tight italic opacity-70">Verify your credentials to enter the console.</p>
            </div>
