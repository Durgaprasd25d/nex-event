...
import api from '../api';
import { Mail, Lock, User, AlertCircle, Zap, ArrowRight, Shield, UserPlus, Eye, EyeOff } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-obsidian flex items-center justify-center p-4 md:p-12 relative overflow-x-hidden pt-24 lg:pt-32">
      ...
      <div className="w-full max-w-[1400px] lg:h-[820px] flex flex-col lg:flex-row gap-0 relative z-10 items-stretch shadow-4xl rounded-2xl overflow-hidden border border-ghost-border">
        ...
        <motion.div
          ...
          className="relative flex-1 min-h-[300px] lg:min-h-0 overflow-hidden group order-2 lg:order-1"
        >
          <img
            src={HERO_BG}
            alt="Atmosphere"
          ...
          <div className="absolute bottom-0 left-0 p-8 lg:p-14 flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base lg:text-xl text-on-surface-variant max-w-lg font-medium leading-relaxed italic opacity-80">
                {showOTP ? "The final step in your activation pulse sequence." : "Join the most exclusive collective of event architects and explorers."}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
          className="flex-1 bg-surface-panel p-8 lg:p-12 flex flex-col justify-between order-1 lg:order-2 overflow-y-auto lg:overflow-visible"
        >
          <div className="flex flex-col gap-8 lg:gap-10 h-full">
            ...
            <div className="space-y-1">
              <h2 className="text-4xl lg:text-5xl font-bold tracking-tighter text-on-surface leading-none">
                {showOTP ? "Identity Verified" : "New Identity"}
              </h2>
              <p className="text-on-surface-variant font-medium text-sm lg:text-base tracking-tight italic opacity-70">
                {showOTP ? "Validate the pulse to initialize your account." : "Initialize your account status within the nexus."}
              </p>
            </div>
